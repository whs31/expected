  ...
  template <class E> class unexpected {
   public:
    ...
    requires std::is_constructible_v<
      E, Args &&...> : m_val(std::forward<Args>(args)...) {}
    template <
      class U, class... Args>
    constexpr unexpected(std::initializer_list<U> l, Args &&...args)
    requires std::is_constructible_v<
      E, std::initializer_list<U> &, Args &&...> : m_val(l, std::forward<Args>(args)...) {}
...
/// tracked by the expected object.
  ...
  void swap(expected<T, E> &lhs,
            expected<T, E> &rhs) noexcept(noexcept(lhs.swap(rhs))) requires ((std::is_void_v<T> ||
